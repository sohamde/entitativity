## Group-Entitativity & Individual-Entitativity vs Mobility simulator
##
...
def step(agents, grid, counts):
	"""
	Steps through evolutionary phases using methods in phases.py
	Follows same sequence of phases as in Hammond & Axelrod 2006: immigration, interaction, reproduction, death
	Mobility phase is added after death phase
	"""
